...
def load_data_pairs(img_path, dmap_path, pmap_path, kmap_path):
    ...
    return img_data, dmap_data, pmap_data, kmap_data


def get_batch_patches(img_path, dmap_path, pmap_path, patch_dim, batch_size, kmap_path):
    rand_img, rand_dmap, rand_pmap, rand_kmap = load_data_pairs(img_path, dmap_path, pmap_path, kmap_path)
    ...
    return batch_img, batch_dmap, batch_pmap, batch_num, batch_kmap
