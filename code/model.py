...
class counting_model(object):
    ...
    def train(self):
        ...
        for epoch in np.arange(self.epoch):
            ...
            for i_dx in rand_idx:
                ...
                batch_img, batch_kmap, batch_pmap, batch_num = get_batch_patches(img_path, dmap_path, kmap_path, pmap_path, self.inputI_size, self.batch_size)
    ...
    def test(self):
        ...
        for k in range(0, len(test_img_list)):
            ...
            SaveDmap(predicted_label[0,:,:,0], labeling_path, mat_variable_name='kmap')
